...
- **Backend**: lihat repo [`asmo-api`](https://github.com/USERNAME/asmo-api)
...
```bash
git clone https://github.com/USERNAME/asmo-mobile.git
cd asmo-mobile
flutter pub get
...
## Git Workflow
Sama seperti [`asmo-api`](https://github.com/USERNAME/asmo-api) — `main` / `develop` / `feature/nama-fitur`, Conventional Commits, PR wajib direview.
